...
public class ProductServiceImpl implements ProductService {
    ...
    public List<ProductResponse> getAll() {
        log.debug("loading all products from DB");
    ...
    public ProductResponse getById(UUID id) {
        log.debug("loading product {} from DB", id);
    ...
    public ProductResponse create(ProductRequest request) {
        ...
        ProductDocument doc = productMapper.toDocument(entity) ;
    ...
    public ProductResponse update(UUID id, ProductRequest request) {
        ...
        ProductDocument doc = productMongoRepository.findByProductId(id)
                .orElse(productMapper.toDocument(entity));
